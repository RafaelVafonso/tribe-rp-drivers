...
class GPIOout{
    public:
         ...
         * @endcode
         */
        inline GPIOout& operator=(bool v) {write(v); return *this;}
         ...
         */
        inline bool operator==(bool v) const {return read() == v;}
 ...
 */
template<uint... Pins> class GPIOBusIn {
    ...
    public:
        ...
        inline uint32_t read() const{
            ...
            for(uint p : {Pins...}){
                if(gpio_state & (1u << p)) result |= (1u << bit);
                ++bit;
            }
         ...
         */
        inline bool operator==(uint32_t v) const{return read() == v;}
 ...
 * @tparam Pins GPIO pin numbers forming the bus.
 */
template<uint... Pins> class GPIOBusOut{
    static constexpr uint Width = sizeof...(Pins);
    ...
    public:
         ...
         */
        inline GPIOBusOut& operator=(uint32_t value){
            write(value);
            return *this;
        }
